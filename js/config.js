...
export const DEMO_MESSAGES = Object.freeze({
  ...
  missingEmailLibrary:
    "EmailJS konnte nicht geladen werden. Bitte prüfen Sie CDN, CSP und Netzwerkzugriff.",
  emailGenerationError:
    "Das PDF wurde erstellt, aber die Benachrichtigungs-Mail konnte nicht verschickt werden.",
});
...
export const PDF_LAYOUT = Object.freeze({
  page: Object.freeze({ left: 20, right: 190, footerY: 270 }),
  logo: Object.freeze({ xRight: 190, y: 20, maxWidth: 45, maxHeight: 12 }),
  addressY:    45,
  dateY:       60,
  subjectY:    80,
  salutationY: 95,
