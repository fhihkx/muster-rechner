...
import { canSendEmail, initEmailJs, sendTrackingEmail } from "./email.js";
...
async function handleFormSubmit() {
  ...
  if (!canSendEmail()) {
    showUiError(DEMO_MESSAGES.missingEmailLibrary);
    return;
  }
  ...
  try {
    ...
    console.error("Offer generation or email notification failed:", error);
    showUiError(error?.message || DEMO_MESSAGES.emailGenerationError);
  } finally {
